...
class User(db.Model):
    ...
    discourse_id=db.Column(db.Integer,nullable=True,unique=True)
    status=db.Column(db.Boolean,nullable=False,default=0)
    notification=db.Column(db.Boolean,nullable=False,default=1)
    webhook_noti=db.Column(db.Boolean,nullable=False,default=1)
    email_noti=db.Column(db.Boolean,nullable=False,default=1)
    #status = db.Column(Enum('0', '1'), nullable=True, default='0', unique=True)
